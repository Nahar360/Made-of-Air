    ...
    <div class="tab-pane fade show active" role="tabpanel" id="pills-all-time" aria-labelledby="pills-all-time-tab">
        ...
        <div class="panel-body">
            ...
            <div class="form-group row float-left">
                <form method="post" action="/stats_pitchfork">
                    <div class="col-sm-12">
            ...
            <#if user??>
                <div class="form-group row float-right">
                    <form method="post" action="/stats_pitchfork" onsubmit="return confirm('Are you sure you want to clear all the music?');">
                        <div class="col-sm-12">
